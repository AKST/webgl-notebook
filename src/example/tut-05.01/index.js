...
export function main () {
  ...
  const state = initControls({
    ...
    entity: {
      translate: [width/2, height/4, 47],
      rotation: [6.60, 19.64, 0.0],
      scale: [1.5, 1.5, 1.5],
    },
  });
  ...
  requestAnimationFrame(function f () {
    ...
    const proj = M.projection(...state.screen.bounds, 400);
    ...
    let matrix = M.fudgeZ(fudge.value);
    matrix = m.mul(proj, matrix);
