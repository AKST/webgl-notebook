...
const fragmentShaderSrc = version + `
  ...
  void main() {
    ...
    outColor = u_color;
    outColor.rgb *= lightDirectional * u_lightColor + lightPoint;
...
export function main () {
  ...
  const uLightColor = getUniformLoc(gl, program, "u_lightColor");
  const uSpecularColor = getUniformLoc(gl, program, "u_specularColor");
  ...
  requestAnimationFrame(function f (t) {
    ...
    gl.uniform3fv(uLightColor, COLOR_D.vec);
    gl.uniform3fv(uSpecularColor, COLOR_E.vec);
